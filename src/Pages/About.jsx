...
//           {/* Avatar Section */}
//           <div className="md:col-span-1 flex justify-center">
//             <div className="relative w-64 h-64 rounded-full bg-blue-400/20 flex items-center justify-center group">
//               <div className="absolute inset-0 rounded-full bg-blue-400/30 blur-xl animate-pulse"></div>
//               <img
//                 src={Profile}
//                 alt="Profile"
//                 className="w-60 h-60 rounded-full z-10 transform transition-transform hover:scale-105"
//               />
//             </div>
//           </div>
...
//                 <button
//                   href="contact"
//                   className="px-6 py-3 bg-blue-500 rounded-lg hover:bg-blue-600 transition-colors flex items-center"
//                 >
//                   Let's Connect
//                 </button>
//               </Link>
